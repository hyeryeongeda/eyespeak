...
if __name__ == '__main__':
    ...
    results = model.train(
        data=r'C:\Users\SSAFY\Desktop\GAZE-CAPTURE\GazeCapture\MPIIGAZE\yolo_dataset\dataset_exp8.yaml', epochs=50, imgsz=640, batch=16,
        workers=4, device=0, project=r'C:\Users\SSAFY\Desktop\GAZE-CAPTURE\GazeCapture\MPIIGAZE\runs\yolo', name='exp8',
    ...
    best = YOLO(r'C:\Users\SSAFY\Desktop\GAZE-CAPTURE\GazeCapture\MPIIGAZE\runs\yolo/exp8/weights/best.pt')
