...
def _load_user_data_from_db(matching_id: int) -> dict | None:
    ...
    try:
        ...
        user_db = []
        all_exprs = data.get("userExpressions") or []
        is_cold_start = len(all_exprs) < 100  # 신규 유저: 표현 100개 미만
        for expr in all_exprs:
            usage = (expr.get("usageCount") or 0)
            if is_cold_start:
                # 초반 학습 가중치: 적은 사용에도 빠르게 패턴 반영
                weight = 1.0 + math.log(usage * 3 + 1)
            else:
                weight = 1.0 + math.log(usage + 1)
            user_db.append({
                "text": expr["text"],
                "source": "user",
...
DEMO_FIXED = {
    "오렌지 주스 마실래?": {
        ...
        "응": [ "오렌지 주스 줘.","오렌지 주스 마시고 싶어.", "응 마실래!"],
        "아니": ["나중에 마실게","안 마실래", "다른 거 줘" ],
    ...
    "알겠어. 손녀 줄 간식 만들러 주방에 잠시 갈게.": {
        ...
        "알겠어": ["알겠어, 예승이가 좋아하겠다.", "다녀와", "기다릴게"],
        "조심해": ["조심해", "요리 조심해서 해", "잘 다녀와"],
    ...
    "무슨 노래 듣고 싶어?": {
        "categories": {"categories": ["나훈아", "임영웅", "송대관"], "sentimentMap": {"나훈아": "긍정", "임영웅": "긍정", "송대관": "긍정"}, "intentMap": {"나훈아": "트로트", "임영웅": "트로트", "송대관": "트로트"}},
        "나훈아": ["테스형 틀어줘", "나훈아 노래 모음집 틀어줘", "둥지 틀어줘"],
        "임영웅": ["임영웅 노래 틀어줘", "임영웅 듣고 싶어", "이제 나만 믿어요 틀어줘"],
        "송대관": ["송대관 노래 틀어줘", "해뜰날 틀어줘", "송대관 좋아"],
    },
    "뭐 듣고 싶어?": {
        "categories": {"categories": ["나훈아", "임영웅", "송대관"], "sentimentMap": {"나훈아": "긍정", "임영웅": "긍정", "송대관": "긍정"}, "intentMap": {"나훈아": "트로트", "임영웅": "트로트", "송대관": "트로트"}},
        "나훈아": ["테스형 틀어줘", "나훈아 노래 좋아", "둥지 틀어줘"],
        "임영웅": ["임영웅 노래 틀어줘", "임영웅 듣고 싶어", "이제 나만 믿어요 틀어줘"],
        "송대관": ["송대관 노래 틀어줘", "해뜰날 틀어줘", "송대관 좋아"],
    },
    "행복하다니 좋네. 먹고 싶은 건 없고?": {
        "categories": {"categories": ["응", "아니", "잘 모르겠어"], "sentimentMap": {"응": "긍정", "아니": "부정", "잘 모르겠어": "중립"}, "intentMap": {"응": "감정", "아니": "감정", "잘 모르겠어": "기타"}},
        "응": ["참기름죽 먹고 싶어", "초코우유 먹고 싶어", "호박죽 먹고 싶어"],
        "아니": ["배 안 고파", "나중에 먹을래", "안 먹을래"],
        "잘 모르겠어": ["아무거나 해줘", "뭐가 있어?", "골라줘"],
    },
    "먹고 싶은 건 없고?": {
...
DEMO_ALIASES = {
    ...
    # 노래 변형
    "노래 듣고 싶어?": "무슨 노래 듣고 싶어?",
    "뭐 듣고 싶어": "무슨 노래 듣고 싶어?",
    "노래 뭐 들을래?": "무슨 노래 듣고 싶어?",
    "노래 틀어줄까?": "무슨 노래 듣고 싶어?",
    "무슨 노래 틀어줄까?": "무슨 노래 듣고 싶어?",
    "트로트 듣고 싶어?": "무슨 노래 듣고 싶어?",
    "뭐 틀어줄까?": "무슨 노래 듣고 싶어?",
}
