...
export interface RecommendationCategoryCatalogItem {
...
export const RECOMMENDATION_CATEGORY_CATALOG: RecommendationCategoryCatalogItem[] = [
  {
    key: 'mood',
    title: '오늘의 기분',
...
export const RECOMMENDATION_FALLBACK_CATEGORY_KEYS: RecommendationCategoryKey[] = [
  'mood',
  'schedule',
  'frequent',
]
