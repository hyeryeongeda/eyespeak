...
export const DEFAULT_CALIBRATION_POINTS: CalibrationPoint[] = [
  ...
  { id: 'p07', label: '7', xPercent: 2, yPercent: 50 },
  { id: 'p08', label: '8', xPercent: 21, yPercent: 50 },
  { id: 'p09', label: '9', xPercent: 40, yPercent: 50 },
  { id: 'p10', label: '10', xPercent: 60, yPercent: 50 },
  { id: 'p11', label: '11', xPercent: 79, yPercent: 50 },
  { id: 'p12', label: '12', xPercent: 98, yPercent: 50 },
  { id: 'p13', label: '13', xPercent: 2, yPercent: 98 },
  { id: 'p14', label: '14', xPercent: 21, yPercent: 98 },
  { id: 'p15', label: '15', xPercent: 40, yPercent: 98 },
  { id: 'p16', label: '16', xPercent: 60, yPercent: 98 },
  { id: 'p17', label: '17', xPercent: 79, yPercent: 98 },
  { id: 'p18', label: '18', xPercent: 98, yPercent: 98 },
]
