...
export default function CareHomePage() {
  ...
  return (
    ...
    >
      ...
      >
        <p style={{ margin: 0, color: '#5f8bb0', fontWeight: 700, fontSize: '14px' }}>CARE MODE</p>
        <h1 style={{ margin: '12px 0 14px', color: '#203042', fontSize: '32px' }}>보호자 홈</h1>
        <p style={{ margin: '0 0 20px', color: '#6d7f8f', lineHeight: 1.6 }}>
          목업 로그인이 정상적으로 완료되었습니다. 이후 보호자 홈 기능은 이 페이지에서 연결하면
          됩니다.
        </p>
